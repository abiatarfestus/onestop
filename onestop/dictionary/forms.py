...
class WordDefinitionForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {'part_of_speech': forms.Select(
            attrs={'class': 'form-select form-select-lg mb-2', 'onchange': 'displayPluralOrTense()'}), 'variants': forms.TextInput(
            attrs={'class': 'form-control form-control-lg mb-2'}), 'plural': forms.TextInput(
            attrs={'class': 'form-control form-control-lg mb-2'}), 'tense': forms.TextInput(

...
urlpatterns = [
    ...
    path(
        "queues/serve-customers/<int:pk>/<int:current_customer>/",
        views.serve_customers,
        name="serve-customers",
    ),
    path(
        "queues/next-customer/<int:pk>/<int:last_served_id>/",
        views.next_customer,
        name="next-customer",
    ),
    path(
        "queues/cancel-customer/<int:pk>/",
        views.cancel_customer,
